...
class ProductFilter(django_filters.FilterSet):
    ...
    minimum_burning_time = django_filters.NumberFilter(field_name='burning_time', lookup_expr='gte')
    maximum_burning_time = django_filters.NumberFilter(field_name='burning_time', lookup_expr='lte')
